...
ページの下に白い表紙などが見える場合は、外側の机との境界だけでなく、明るい紙同士を分ける長い内側の境界も調べます。内側の境界が十分明確ならページ側を採用し、レビュー画面にその旨を表示します。境界の色差が小さい場合や手で長く隠れる場合は表紙側を選ぶ可能性があるため、重なりが大きい場面は仕上がりを確認してください。
